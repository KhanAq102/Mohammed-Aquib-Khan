...
const TenderList: React.FC<TenderListProps> = ({ tenders, selectedTenderId, onSelectTender, onAddTender, onDeleteTender }) => {
    return (
        <div className="p-4">
                    ...
                    return (
                        <li key={tender.id} className="group relative">
                            ...
                            >
                             ...
                             <div className={`absolute top-1/2 -translate-y-1/2 right-3 transition-opacity ${isSelected ? 'opacity-0' : 'opacity-0 group-hover:opacity-100'}`}>
                                <button
